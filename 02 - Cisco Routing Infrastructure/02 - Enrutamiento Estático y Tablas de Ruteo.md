# Enrutamiento Estático: Análisis y Resolución de Topologías Complejas
...
```bash
# Ej: Tabla 13 (ROUTER 7)
Router(config)# ip route 172.22.34.0 255.255.255.0 10.0.2.2
````

_(Este proceso se repitió sistemáticamente en cada nodo para asegurar respuestas bidireccionales y evitar el error "Destination Unreachable")._
...
Tras configurar todos los saltos, validamos que la información se haya guardado correctamente en la memoria de los equipos.
