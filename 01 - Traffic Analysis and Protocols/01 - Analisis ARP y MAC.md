...
![[Pasted image 20260611041748.png]]

*// CANDELA: Acá pega la captura de tu Word (ACT 1.2) donde ejecutaste el `route -n`, `ip route` y el `ping 172.22.32.1` en tu terminal de Linux.*
...
![[imagen_wireshark_trama_ethernet.png]]
*// CANDELA: Acá pega la captura de Wireshark de tu Word donde tenés seleccionada la fila "Ethernet II" y se ven claramente la "Destination MAC" y la "Source MAC".*
...
![[imagen_wireshark_arp.png]]
*// CANDELA: Acá pega la captura de Wireshark donde filtramos por ARP y se ve la típica pregunta "Who has 172.22... ? Tell 172.22..." (ARP Request) y la respuesta (ARP Reply).*
